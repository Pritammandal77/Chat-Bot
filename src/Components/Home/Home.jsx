...
function Home() {
    ...
    const appNameheadRef = useRef()
    useGSAP(() => {
      gsap.from(appNameheadRef.current, {
        opacity: 0,
        x: -200,
        duration: 0.7,
    ...
    const appNameBodyRef = useRef()
    useGSAP(() => {
      gsap.from(appNameBodyRef.current, {
        opacity: 0,
        y: 100,
        duration: 0.7,
            ...
            <div className="welcomeContainer">
                <div className="appHeading">
                    <div className="appTitleDiv">
                        <h1 className="appTitle" ref={appNameheadRef}>Welcome to AuraAI </h1>
                        <div className="loader"></div>
                    </div>

                    <h2 className="para" ref={appNameBodyRef}>Your Personal AI chat Assistant !!</h2>

                </div>

                <div className="cards" ref={boxesRef}>
                    <div className="card" >
                        <p className="heading">
                            This is A ChatBot <br />Created By <br />Pritam Mandal
                        </p>
                        <p>
                            Powered By
                        </p>
                    ...
                    <div className="card" >
                        <p className="heading">
                            Ask Anything <br />Ask About Your Code <br /> Debug Your Code
                        </p>
                        <p>
                            Powered By
                        </p>
